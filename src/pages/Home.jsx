        ...
        <div className="home-content1 ">
          <div className="content">
            ...
            <div className="button-container">
              <button className="button"><a className="dropdown-item" href="/product">View details</a></button>
            </div>
          </div>
          <div className="content">
            <div>
            ...
            <div className="button-container">
              <button className="button"><a className="dropdown-item" href="/product1">View details</a></button>
            </div>
          </div>
          <div className="content">
            <div>
            ...
            <div className="button-container">
              <button className="button"><a className="dropdown-item" href="/product2">View details</a></button>
            </div>
          </div>
        </div>
        ...
        <div className="home-content2">
          ...
          <div className="home-container2">
            ...
            <div className="home-container-button">
              <button className="button"><a className="nav-link" href="/about">View details</a></button>
            </div>
          </div>
        </div>
